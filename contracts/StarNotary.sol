...
contract StarNotary is ERC721 {
    ...
    string public name = "John Star";
    string public symbol = "JSTR";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerAddress1 || msg.sender == ownerAddress2, "Sender does not own one of the tokens");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId);
        require(msg.sender == ownerAddress, "Sender does not own the token");
